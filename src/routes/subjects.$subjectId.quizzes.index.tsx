    ...
    <div className="relative min-h-screen">
      ...
      <header className="relative z-10 border-b border-border/60 bg-background/60 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link to="/subjects/$subjectId" params={{ subjectId }} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
        ...
        <div className="cosmic-card rounded-3xl p-6 md:p-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">اختار اختبار وابدأ — هتلاقي تفسير لكل إجابة بعد التسليم.</p>
            </div>
            {isAdmin && (
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      {q.description && <p className="mt-0.5 text-xs text-muted-foreground line-clamp-1">{q.description}</p>}
                    </div>
                  </div>
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="block text-sm">
              <span className="mb-1 block text-xs text-muted-foreground">المدة (دقيقة)</span>
            ...
            <label className="block text-sm">
              <span className="mb-1 block text-xs text-muted-foreground">درجة النجاح %</span>
